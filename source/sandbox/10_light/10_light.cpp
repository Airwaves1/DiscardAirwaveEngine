...
//         phongMaterial.specularMap = Airwave::Texture2D::Create(TEXTURE_DIR "container2_specular."
//                                                                            "png");
...
//         cameraComponent.camera = std::make_shared<Airwave::PerspectiveCamera>(
...
//             cameraEntity->addComponent<Airwave::FPSCameraControllerComponent>();
//         cameraControllerComponent.controller =
//             std::make_shared<Airwave::FPSCameraController>(cameraComponent.camera);
//     }
