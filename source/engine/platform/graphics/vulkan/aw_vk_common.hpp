...
static const char *vk_format_string(VkFormat format)
{
    switch (format)
    {
        ...
        ENUM_TO_STR(VK_FORMAT_A1B5G5R5_UNORM_PACK16_KHR);
        ...
        ENUM_TO_STR(VK_FORMAT_A8_UNORM_KHR);
        ...
        ENUM_TO_STR(VK_FORMAT_R16G16_SFIXED5_NV);
...
static const char *vk_image_layout_string(VkImageLayout layout)
{
    switch (layout)
    {
        ...
        ENUM_TO_STR(VK_IMAGE_LAYOUT_RENDERING_LOCAL_READ_KHR);
        ...
        ENUM_TO_STR(VK_IMAGE_LAYOUT_ATTACHMENT_FEEDBACK_LOOP_OPTIMAL_EXT);
